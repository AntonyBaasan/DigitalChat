...
describe("Digital Chat Socket Test :: ", function () {
    describe("Messge type field:", function () {
        it("should send chat to directed user", function (done) {
            ...
            client1.on("welcome", function (data) {
                setTimeout(function () {
                    client1.emit("talkToPeer", { "fromUser": "Client1", "toUser": "Client2", "content": "Hello world", "msgType": "FIGHT_REQUEST" });
                }, 500);
            });
            ...
            client2.on("talkToPeer", function (data) {
                ...
                assert.equal(data["msgType"], "FIGHT_REQUEST");
